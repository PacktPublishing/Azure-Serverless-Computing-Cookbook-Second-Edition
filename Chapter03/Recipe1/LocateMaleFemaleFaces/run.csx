...
public static async Task Run(Stream image, string name, IAsyncCollector<FaceRectangle> outMaleTable,
IAsyncCollector<FaceRectangle>  outFemaleTable, TraceWriter log)
{
