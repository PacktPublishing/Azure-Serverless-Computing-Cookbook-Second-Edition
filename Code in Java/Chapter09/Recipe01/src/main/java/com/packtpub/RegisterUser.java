...
public class RegisterUser {
    ...
    public HttpResponseMessage run(
        ...
        if (json != null) {
            ...
            employee.setEmailAddress(request.getQueryParameters().get("emailAddress"));
            employee.setMobileNumber(request.getQueryParameters().get("mobileNumber"));
        }
        ...
        if (StringUtils.isBlank(employee.getFirstName()) 
                ...
                || StringUtils.isBlank(employee.getEmailAddress())
                || StringUtils.isBlank(employee.getMobileNumber())) {
